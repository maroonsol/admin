...
// Singapore States/Regions
export const singaporeStates = [
  "Central Region",
  "East Region",
  "North Region",
  "North-East Region",
...
export const hsnSacCodes = [
  ...
  {
    code: "998316",
    description: "Website development and hosting services",
    igst: 18,
    cgst: 9,
    sgst: 9
  },
  ...
  {
    code: "998231",
    description: "GST filing and compliance services",
    igst: 18,
    cgst: 9,
    sgst: 9
  },
  ...
  {
    code: "998396",
    description: "Trademarks and franchises / Trademark services",
    igst: 18,
    cgst: 9,
    sgst: 9
  },
...
// Major currencies for export invoices
...
export const companyInfo = {
  name: "MAROONSOL PRIVATE LIMITED",
  address: "Khairatali, Mittan Chak, Patna, Bihar, India, 804453",
  email: "info@maroonsol.com",
  phone: "(+91) 9305166411",
  gstin: "10AATCM8978R1Z8",
  pan: "AATCM8978R",
  cin: "U69100BR2025PTC079059",
  bankDetails: {
    accountHolder: "Maroonsol Private Limited",
    accountNumber: "925020031020697",
    ifsc: "UTIB0005552",
    branch: "KURTHAUR PARSA BRANCH",
    swiftCode: "AXISINBB142",
    bankName: "Axis Bank"
  }
};
